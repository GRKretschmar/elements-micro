...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[width=0.8\textwidth]{img4.jpg}
\end{minipage}
\end{frame}
\end{comment}
...
\begin{frame}{Outline}
    This week will cover chapters 1 of the Mankiw textbook:
    \begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item How do economists think? (More on this next week)
    \end{itemize}
\end{frame}
...
\begin{enumerate}
    ...
    \item For an airline, the marginal cost of flying one additional passenger on a flight that is not fully booked
    \item For an airline, the marginal cost of flying one additional passenger when the current flight is fully booked
