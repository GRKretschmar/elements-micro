...
\begin{frame}
    ...
    \centering
    \includegraphics[width = 0.7\textwidth,keepaspectratio]{W3 demand_curve.png}
...
\begin{frame}{Market for Orioles tickets}
    In the last few years, the Orioles have gone from one of the worst teams in MLB to one of the best. (Rather, let's pretend that is still the case)
