...
\begin{frame}{Putting It All Together}
    ...
    Let's Draw an Example where we experience a price change of one good.
    \begin{enumerate}
        \item According to the income effect, will we demand more or less of each good?
        \item According to the substitution effect, will we demand more or less of each good?
        \item What can we say happens to the consumption bundle? Is anything left ambiguous?
    \end{enumerate}
...
\begin{frame}{Further Discussion}
    ...
    Consumer theory is the primitive from which we back out the Law of Demand

    \vspace{3pt}

    Your textbook gives a good treatment on a few things that I think are worth pointing out. These are:
    \begin{enumerate}
        \item Giffen Goods (Show that indifference curves of a certain shape imply a good is a Giffen Good)
        \item Wages and the labor supply (See if you are interested in microeconomics or macroeconomics research)
        \item Interest Rates and Household Savings
        \begin{itemize}
            \item This treat consumption today and consumption tomorrow as two different goods. You can think of the interest rate being a change in the relative price of the two. 
            \item This concept is the foundational for most of the macroeconomic theory you see at the grad school level. See discussion in the book if you are interested in macro or finance.
        \end{itemize}
    \end{enumerate}
