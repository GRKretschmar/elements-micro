...
% Title page details: 
\title{Chapters 6 and 7: Supply, Demand, and Government Policies} 
...
\begin{frame}{Review: Elasticities}
    ...
    \begin{block}{Clarification}
        \begin{enumerate}
            \item You can ignore the absolute values; I find these concepts more intuitive without them
        \end{enumerate}
...
\begin{frame}{Review: Elasticities}
    ...
    \begin{block}{Clarification}
        \begin{enumerate}
            \item This two are related! Do you see the intution from calculus
            \item Be careful! Pay attention to whether you need the slope from the inverse demand curve or the normal one
        \end{enumerate}
