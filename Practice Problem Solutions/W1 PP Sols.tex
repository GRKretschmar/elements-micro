...
\subsection*{Question 1: Opportunity Cost}
...
The opportnity cost should be whatever the benefit of your second best option would be.
...
\begin{enumerate}
    \item The marginal benefit of your first glass of water for the day \textbf{high}
    \item The marginal benefit of your seventeenth glass of water for the day \textbf{low}
    \item The cost of streaming an additional movie when you already have netflix \textbf{zero \dots}
    \item The cost of streaming an additional movie on a streaming service you don't already own \textbf{high}
    \item The marginal benefit of your first hour of studying for your upcoming econ 102 exam \textbf{high}
    \item The marginal cost of your 30th hour studying in a row \textbf{high}
    \item For an airline, the cost of flying one additional passenger on a flight that is not fully booked \textbf{low}
    \item For an aireline, the cost of flying one additional passenger when the current flight is fully booked \textbf{high}
    
\end{enumerate}


\subsection*{Question 3: Trade-offs}
What is the source of trade-offs? Can you give an example from your own life?

Answer: Scarcity is the source of tradeoffs. For this example, I will use the tradeoff between study time and sleep time. For the purposes of this example, you may assume that is all I do. If I have 24 hours in a day, I can choose to spend all of them studying, all of them sleeping, or some mix between the two. If I wanted to study more, I would need to sleep less. And vice versa. This tradeoff exists because my time is scarce. If I had more time, I could actually do both more studying and more sleeping.   
\begin{comment}
