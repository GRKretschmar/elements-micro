...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 market_for_gas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 tax_cut.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 increase_efficiency.png}
...
\item From our previous answers, we know:
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.6\textwidth]{W3 both_changes_1a.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.6\textwidth]{W3 both_changes_1b.png}
        \caption{Tax cut and increased efficiency}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 decrease_efficiency.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 both_changes_2a.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 both_changes_2b.png}
    \caption{Tax cut and decreased efficiency}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 orioles.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{W3 orioles_changes.png}
